...
public class MockHorizonServer {
    ...
    public void createVerifyStructure(String method) {
        HttpRequest[] recordedRequests = mockServerClient
    ...
    public void createVerifyEventType() {
        ...
        try {
            assertEquals("de.telekom.ei.listener.spectre", om.readValue(seEventString, Spectre.class).getType());
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    private List<Header> getHeaderList(String id) {
        ...
        headersList.add(new Header(HttpHeaders.USER_AGENT, "ReactorNetty/1.0.33"));
