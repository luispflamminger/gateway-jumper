...
public class VerificationSteps {
    ...
    public void apiProvidersReceivesNoTechnicalHeaders() {
        this.baseSteps.getRequestExchange()
                .expectHeader().doesNotExist("jumper_config")
                .expectHeader().doesNotExist("token_endpoint")
                .expectHeader().doesNotExist("remote_api_url")
                .expectHeader().doesNotExist("issuer")
                .expectHeader().doesNotExist("client_id")
                .expectHeader().doesNotExist("client_secret")
                .expectHeader().doesNotExist("api_base_path")
                .expectHeader().doesNotExist("x-consumer-id")
                .expectHeader().doesNotExist("x-consumer-custom-id")
                .expectHeader().doesNotExist("x-consumer-groups")
                .expectHeader().doesNotExist("x-consumer-username")
                .expectHeader().doesNotExist("x-anonymous-consumer")
                .expectHeader().doesNotExist("x-anonymous-groups")
                .expectHeader().doesNotExist("x-forwarded-prefix")
                .expectHeader().doesNotExist("access_token_forwarding")
        ;
    }
