        ...
        baseSteps.setHttpHeadersOfRequest(
                baseSteps.httpHeadersOfRequest.andThen(
                        httpHeaders -> {
                            ...
                            switch (jc_case) {
                                case "consumer":
                                    httpHeaders.set(Constants.HEADER_JUMPER_CONFIG, getJcRouteListener(baseSteps.getId(), Config.CONSUMER));
                                    break;
                                case "otherConsumer":
                                    httpHeaders.set(Constants.HEADER_JUMPER_CONFIG, getJcRouteListener(baseSteps.getId(), Config.CONSUMER_EXTERNAL_CONFIGURED));
                                    break;
                            }
                        }
                )
