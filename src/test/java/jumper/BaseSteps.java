...
public class BaseSteps {
    ...
    public void consumerCallsTheListenerRoute() {
        ...
        requestExchange = webTestClient.get().uri("/listener/callback?statusCode=" + responseStatusCode).headers(httpHeadersOfRequest).exchange();
    }
        ...
        switch (method) {
            case "HEAD":
                requestExchange = webTestClient
                        ...
                        .headers(httpHeadersOfRequest).exchange();
                break;
            case "POST":
                requestExchange = webTestClient
                        .post()
